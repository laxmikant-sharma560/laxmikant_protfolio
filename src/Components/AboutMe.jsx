          ...
          <div className="">
            <div className="max-w-xl relative z-10 flex justify-center items-start flex-col text-start w-full h-full py-10">
              ...
              <h1 className="max-w-xl text-xl text-purple-300">
                I'm Laxmikant Sharma, a full-stack React-JS & Python developer{" "}
                <span className="px-1 text-white">
                  with a passion for creating dynamic applications using the
                  Full stack (Python, DJango, React, Numpy , and Pandas). I
                  specialize in front-end and back-end development, as well as
                  database management. I also have experience using CSS
