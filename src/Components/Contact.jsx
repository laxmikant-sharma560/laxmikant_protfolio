        ...
        <div className="hidden lg:block w-full md:w-1/2 lg:w-2/3 m-3 bg-gray-800 p-5 rounded">
          ...
          <div className="text-center mt-3 hidden lg:block">
            <p className="text-lg text-[#FFF]">
              ...
              me an email at slaxmikant560@gmail.com . I'll do my best to get back to
          ...
          <div className="flex text-white flex-col mx-24 mt-8 text-xl">
            <div className="bg-gray-600 p-2 rounded-lg m-1 flex">
              ...
              <p className="text-bold inline ml-3">slaxmikant560@gmail.com</p>
            </div>

            <a
              href="https://github.com/laxmikant-sharma560"
            ...
            >
              ...
              <p className="text-bold inline ml-3">@laxmikant-sharma560</p>
            </a>

            <a
              href="https://www.linkedin.com/in/laxmikant-sharma-9a1241285/"
              className="bg-gray-600 p-2 rounded-lg m-1 flex"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <p className="text-bold inline ml-3">@Laxmikant-Sharma</p>
            </a>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit}>
            {Feedback ? (
              ...
              <div className="flex justify-center items-center">
                ...
                <div>
                  <img className="w-24 mx-auto mb-5" alt="contact-brand-logo" src="/img/laxmikant-1.png.jpg" />
                </div>
              </div>
            )}
