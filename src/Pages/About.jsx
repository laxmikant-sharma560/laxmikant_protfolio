    ...
    <>
      ...
      <div className="flex flex-col-reverse justify-around items-center p-1 mx-auto sm:py-12 lg:py-18 lg:flex-row lg:justify-evenly">
        <p className="text-gray-300 text-xl m-4 sm:mx-24 w-fit">
          Hello there! My name is Laxmikant Sharma and I am currently pursuing a
          B.Tech in computer science and Information engineering. After completing my 10th  and 12th
          grade, I decided to pursue this field because of my love for computers
          and the tech world.
          <br />
          <br /> As a full stack web developer, I specialize in using the 
          full-stack React-JS & Python developer applications. I also have experience using popular
          ...
          actively learning and expanding my skills in both Python and AI/ML. In
